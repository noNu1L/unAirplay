...
def check_ffmpeg_or_exit(tag: str = "Startup"):
    ...
    log_error(tag, "    2. Extract to C:\\ffmpeg")
    log_error(tag, "    3. Add C:\\ffmpeg\\bin to system PATH")
    ...
    log_error(tag, "    2. 解压到: C:\\ffmpeg")
    log_error(tag, "    3. 将 C:\\ffmpeg\\bin 添加到系统环境变量 PATH")
